  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1180px] flex-col items-center px-5 pb-16 pt-[clamp(7.5rem,12vh,9.5rem)] md:px-8 md:pb-20">
        ...
        <div className="relative mt-[clamp(2.9rem,5.4vh,4.6rem)] grid w-full max-w-[840px] grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 lg:gap-[14px] lg:[transform:translateY(68px)_scale(0.92)]">
          <div
            aria-hidden="true"
