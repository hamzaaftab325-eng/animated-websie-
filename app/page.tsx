...
import { useHomepageAnimation } from '../hooks/use-homepage-animation';
...
export default function Page() {
  ...
  useHomepageAnimation(rootRef);

  return (
    <div ref={rootRef}>
      <a className="skip-link" href="#possibilities">Skip to content</a>
      {/* Pure High-Quality Background Video Stage */}
      <div className="stage" aria-hidden="true">
        <video id="clip" muted playsInline preload="metadata" poster="https://res.cloudinary.com/diometfe9/video/upload/so_0,f_auto,q_auto/v1790182288/Create_cinematic_zoom_effect_video_20260923214757_m00y5v.jpg" disablePictureInPicture></video>
      </div>
      ...
      <div className="panels">
        ...
        <section className="panel" data-panel>
          <div className="content-block">
            ...
            <h2 className="hero-title">TRANSFORM</h2>
      ...
      <div className="track" id="heroTrack" aria-hidden="true"></div>
      ...
      >
        ...
        <div className="cards-grid">
          ...
          <div
            ...
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setActiveModal(CARDS_DATA[0]); } }}
          >
          ...
          <div
            ...
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setActiveModal(CARDS_DATA[1]); } }}
          >
            <div className="card-icon-wrap" aria-hidden="true">
              {/* Mountain icon */}
              <svg viewBox="0 0 32 32" className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div
            ...
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setActiveModal(CARDS_DATA[2]); } }}
          >
            <div className="card-icon-wrap" aria-hidden="true">
              {/* Sun icon */}
              <svg viewBox="0 0 32 32" className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div
            ...
            onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setActiveModal(CARDS_DATA[3]); } }}
          >
            <div className="card-icon-wrap" aria-hidden="true">
              {/* Leaf icon */}
              <svg viewBox="0 0 32 32" className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="projects-liquid-content">
                ...
                <div className="projects-liquid-button-wrap">
                  <a
                    ...
                    href="/animation-lab"
                    aria-label="Explore the animation studies"
                  >
      ...
      <FeatureDialog card={activeModal} onClose={() => setActiveModal(null)} />
    </div>
  );
}
